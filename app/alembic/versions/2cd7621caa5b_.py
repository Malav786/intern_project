...
Revision ID: 2cd7621caa5b
Revises: b24e76e9c858
Create Date: 2023-06-21 13:33:47.120895
...
revision = '2cd7621caa5b'
down_revision = 'b24e76e9c858'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['created_by'], ['user_details.id'], name='images_created_by_fkey'),
